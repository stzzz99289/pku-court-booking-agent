...
SELECTORS: dict[str, str] = {
    ...
    "iaaa_login_link": 'role=link[name="统一身份认证登录（IAAA）"]',
    "iaaa_username_input": 'input[placeholder="User ID / PKU Email / Cell Phone"]',
    "iaaa_password_input": 'input[placeholder="Password"]',
    "iaaa_submit": 'role=button[name="Login"]',
